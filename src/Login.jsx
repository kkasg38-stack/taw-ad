...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    if (username === "T" && password === "Ya3omri2029") {
  ...
  return (
    <div className="w-full flex items-center justify-center md:justify-start flex-col gap-y-5 py-5 h-screen">
      <img src="/logo.jpeg" className="bg-[#213cc6] rounded-2xl" />
      <h3 className="mb-4 font-bold text-xl text-center"> أدمن توثيق </h3>
      <form onSubmit={handleSubmit} className="md:w-1/3 w-10/12 flex flex-col">
        {errorMsg && (
        ...
        <button
          type="submit"
          className="bg-[#213cc6] text-white px-5 py-2 rounded-md  mt-10 w-1/2 self-center"
        >
          Sign In
        </button>
      </form>
